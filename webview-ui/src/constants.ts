...
export const WANDER_THOUGHT_CHANCE = 0.15; // 15% chance to show thought bubble when idle
export const FURNITURE_BUBBLE_DURATION_SEC = 3.0; // how long the furniture interaction bubble shows
export const THOUGHT_BUBBLE_DURATION_SEC = 4.0; // how long the thought bubble shows
